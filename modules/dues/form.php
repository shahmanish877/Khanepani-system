...
<div>
	<h1 class="title">Add/Edit Dues</h1>
</div>
	...
	<?php 
		...
		foreach ($client as $c) {
				...
				$query = "SELECT cid FROM client_dues WHERE cid=".$cid;
			...
			?>
				<form method="post" action="?page=dues_form">
					...
					<tr>
						...
						<td>  
							<p class="to-picker"></p>
							<input type="hidden" name="dues_date" class="dues_date" id="to-picker1" class="form-controlled">
			...
			echo '<a href="?page=dues" class="btn btn-danger">Cancel</a> </form>' ;
