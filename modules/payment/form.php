<link href="css\nepali.datepicker.v3.min.css" rel="stylesheet" type="text/css" />
 ...
 -->
		...
		<select class="form-controlled" name="cust_name" id="cust_name">
			...
			<div class="form_right">
				...
				<input type="radio" id="yes" name="dues_clear" class="dues_clear" value="yes" required> <label for="yes">Yes</label> <input type="radio" id="no" name="dues_clear" class="dues_clear" value="no" required> <label for="no">No</label>
	...
	<br>
				...
				<input type="number" name="new_dues" id="new_dues" class="form-controlled" step="any">
...
<script src="js\nepali.datepicker.v3.min.js" type="text/javascript" ></script>
...
function ajax_function(){
        ...
        $.ajax({
            url: "modules/payment/mass_reading.php",
            type: 'GET',
            dataType: 'json',
	...
	$(document).on("input", "#discount", function () {
		...
		for(i=1;i<=count;i++){
	     ...
	     for(i=1;i<=count;i++){
			...
			total_with_fine = total_with_fine - $('#discount').val() -  $('#dues_return').val();
			$('#total').val(total_with_fine);
			$('#total1').val(total_with_fine);


			var grand_total = total_with_fine   + (+client_dues);
