...
if(isset($_POST["query"]))
{
	...
	$query = "SELECT client_advance.*, client.name,client.meter
					FROM client_advance
					INNER JOIN client
					ON client_advance.cid=client.id where client.name LIKE '%".$search."%' LIMIT $offset, $no_of_records_per_page ";
	...
	while($d = mysqli_fetch_array($result))
	{
		...
		$output .= '
			<tr>
				...
				<td>
					<a href="?page=advance_update&id='.$d['id'].'">
						Update
					</a> 
					|
					<a href="?page=advance&del_id='.$id.'" onclick="return confirm(\'Do you want to delete?\');">
					Delete
				</a> 
				</td>
