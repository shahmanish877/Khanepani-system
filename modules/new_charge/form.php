...
if(isset($_GET['edit_id']))
{
	...
	$s = $new_charge->getSingle($_GET['edit_id']);
...
<div>
	...
	<div class="form-box">
		<form method="post" action="?page=new_charge_form">
			...
			<h5>Note: * are the required fields.</h5> <br>
				...
				<input type="number" class="form-controlled" value="<?php echo $s['membership']; ?>" name="membership" id="membership"/>
			...
			<a href="?page=new_charge" class="btn btn-danger">Cancel</a>
...
<script>
	...
	function total_sum(){
		...
		var total = (+meter) + (+misc) + (+filter) + (+membership);
